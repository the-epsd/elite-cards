      ...
      <div className="flex-1 flex flex-col">
        <main className="flex-1 py-6 px-6">
          <PageTransition>
            {/* Header */}
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-gray-900">Pokemon TCG (English)</h1>
              <p className="mt-2 text-gray-600">
                Search Pokemon cards and add them to the catalog
              </p>
            </div>
              ...
              <form onSubmit={handleSearch} className="space-y-4">
                <div className="flex gap-4">
                  <div className="flex-1">
                    <input
                      type="text"
                      placeholder="Search for Pokemon cards (optional)..."
                      value={searchQuery}
